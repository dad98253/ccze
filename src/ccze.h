...
typedef enum
{
  ...
  CCZE_COLOR_PKG,
  CCZE_COLOR_DXSCHAN,
  CCZE_COLOR_DXSCHANDIRLEFT,
  CCZE_COLOR_DXSCHANDIRRIGHT,
  CCZE_COLOR_DXSCHANDIRX,
  CCZE_COLOR_DXSCHANNAME,
  CCZE_COLOR_DXSCHANERROR, 
  CCZE_COLOR_DXSCHANERRORTYPE,
  CCZE_COLOR_DXSPROGRESS,
  CCZE_COLOR_DXSPROGRESSTYPE,
  CCZE_COLOR_DXSDXCALL,
  CCZE_COLOR_DXSDXFREQUENCY,
  CCZE_COLOR_DXSDXSPOTTER,
  CCZE_COLOR_DXSNODE,
  CCZE_COLOR_DXSDXCOMMENT,
  CCZE_COLOR_DXSDXROUTE,
  CCZE_COLOR_DXSPC9XNUM,
  CCZE_COLOR_DXSPCNUM,
  CCZE_COLOR_DXSPCDELIM,
  CCZE_COLOR_DXSPCMESSAGENUMS,
  CCZE_COLOR_DXSPCMESSAGEWORDS,
  CCZE_COLOR_DXSPCHOPS,  
